...
model.save('Reconocimiento Facial/models/face_recognition_model.h5')  # Guardar el modelo entrenado en un archivo
np.save('Reconocimiento Facial/models/class_names.npy', class_names)  # Guardar los nombres de las clases en un archivo
